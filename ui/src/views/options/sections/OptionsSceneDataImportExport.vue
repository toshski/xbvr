    ...
    restoreContent () {
      if (this.uploadData !== '' || this.bundleUrl!='') {
        ...
        ky.post('/api/task/bundle/restore', {
          ...
          inclVolumes: this.includeVolumes, inclExtRefs: this.includeExternalReferences, inclSites: this.includeSites, inclSqlCmds: this.includeSqlCommands, inclSqlCmds: this.includeSqlCommands, inclActors: this.includeActors,inclActorActions: this.inclActorActions, 
