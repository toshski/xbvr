...
func (i SceneResource) getFilters(req *restful.Request, resp *restful.Response) {
	...
	outAttributes = append(outAttributes, "Is 2D")
	outAttributes = append(outAttributes, "Is VR")
	...
	outAttributes = append(outAttributes, "Has OCounter")
	...
	outAttributes = append(outAttributes, "Has Male Actor")
	outAttributes = append(outAttributes, "Has Multiple Male Actors")
	outAttributes = append(outAttributes, "Has 1 Female Actor")
	outAttributes = append(outAttributes, "Has 2 Female Actors")
	outAttributes = append(outAttributes, "Has 3 Female Actors")
	outAttributes = append(outAttributes, "Has 3+ Female Actors")
